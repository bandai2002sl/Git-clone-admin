...
import hochuaServices from "~/services/kenhMuongServices";
...
export default function AddNewItemModal({ isOpen, onClose }: AddNewItemModalProps) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            let res: any = await kenhMuongServices.createKenhMuong(form)
                ...
                <ModalBody>
                    <div className={styles["modal-body"]}>
                        ...
                        <Input
                            type="number"
                            name="chieuDaiKienCo"
                            label="Chiều dài kiên cố:"
                            placeholder="Nhập chiều dài kiên cố:"
                            isRequired
                        />

...
export default function Page() {
    ...
    const handleAdd = async () => {
        try {
            const response = await benhVatNuoiSevices.createBenhVatNuoi(newItem)
    ...
    const handleUpdate = async (editedItem: any) => {
        try {
            const response = await benhVatNuoiSevices.updateBenhVatNuoi(editedItem.id, editedItem);
    ...
    const handleConfirmDelete = async (deleteItem: any) => {
        try {
            const response = await benhVatNuoiSevices.deleteBenhVatNuoi(deleteItem.id);

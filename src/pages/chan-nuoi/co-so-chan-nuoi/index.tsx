...
import coSoChanNuoiSevices from "~/services/coSoChanNuoiSevies";
...
export default function Page() {
    ...
    const handleAdd = async () => {
        try {
            const response = await coSoChanNuoiSevices.createCoSoChanNuoi(newItem)
    ...
    const handleUpdate = async (editedItem: any) => {
        try {
            const response = await coSoChanNuoiSevices.updateCoSoChanNuoi(editedItem.id, editedItem);
    ...
    const handleConfirmDelete = async (deleteItem: any) => {
        try {
            const response = await coSoChanNuoiSevices.deleteCoSoChanNuoi(deleteItem.id);

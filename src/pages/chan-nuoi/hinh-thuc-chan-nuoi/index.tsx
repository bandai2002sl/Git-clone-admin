...
export default function Page() {
    ...
    const handleAdd = async () => {
        try {
            const response = await hinhThucChanNuoiSevices.createHinhThucChanNuoi(newItem)
    ...
    const handleUpdate = async (editedItem: any) => {
        try {
            const response = await hinhThucChanNuoiSevices.updateHinhThucChanNuoi(editedItem.id, editedItem);
    ...
    const handleConfirmDelete = async (deleteItem: any) => {
        try {
            const response = await hinhThucChanNuoiSevices.deleteHinhThucChanNuoi(deleteItem.id);

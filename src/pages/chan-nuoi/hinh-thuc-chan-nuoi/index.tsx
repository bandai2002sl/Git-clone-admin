...
import AddNewItemModal from "~/components/page/chan-nuoi/hinh-thuc-chan-nuoi/modalAddNew"
import BaseLayout from "~/components/layout/BaseLayout";
import Button from "~/components/common/Button";
import Head from "next/head";
import ModalEdit from "~/components/page/chan-nuoi/hinh-thuc-chan-nuoi/modalEdit"
...
export default function Page() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const response = await hinhThucChanNuoiSevices.displayHinhThucChanNuoi(data);
    ...
    const handleConfirmDelete = async (deleteItem: any) => {
        try {
            let res: any = await hinhThucChanNuoiSevices.deleteHinhThucChanNuoi(deleteItem.id);
    ...
    return (
        <Fragment>
            ...
            <div>
                <CheckPermission
                    pageKey={PageKey.Hinh_thuc_chan_nuoi}

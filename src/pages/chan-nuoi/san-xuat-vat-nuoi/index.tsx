...
import AddNewItemModal from "~/components/page/chan-nuoi/san-xuat-vat-nuoi/modalAddNew";
import "bootstrap/dist/css/bootstrap.min.css";
import { Modal, ModalBody, ModalFooter, ModalHeader } from "reactstrap";
import sanXuatVatNuoiSevices from "~/services/sanXuatVatNuoiSevices";
import ModalEdit from "~/components/page/chan-nuoi/san-xuat-vat-nuoi/modalEdit";
...
export default function Page() {
    ...
    const handleConfirmDelete = async (deleteItem: any) => {
        try {
            let res: any = await sanXuatVatNuoiSevices.deleteSanXuatVatNuoi(deleteItem.id);
    ...
    return (
        <Fragment>
            ...
            <div>
                <CheckPermission
                    pageKey={PageKey.San_xuat_vat_nuoi}

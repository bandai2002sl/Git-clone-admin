...
export default function Page() {
    ...
    const handleAdd = async () => {
        try {
            const response = await hanHanSevices.createHanHan(newItem)
    ...
    const handleUpdate = async (editedItem: any) => {
        try {
            const response = await hanHanSevices.updateHanHan(editedItem.id, editedItem);
    ...
    const handleConfirmDelete = async (deleteItem: any) => {
        try {
            const response = await hanHanSevices.deleteHanHan(deleteItem.id);

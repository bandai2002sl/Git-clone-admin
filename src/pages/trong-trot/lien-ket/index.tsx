...
import AddNewItemModal from "~/components/page/trong-trot/lien-ket/modalAddNew";
import "bootstrap/dist/css/bootstrap.min.css";
import { Modal, ModalBody, ModalFooter, ModalHeader } from "reactstrap";
import lienKetSevices from "~/services/lienKetSevices";
import ModalEdit from "~/components/page/trong-trot/lien-ket/modalEdit";
...
export default function Page() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const response = await lienKetSevices.displayLienKet(data);
    ...
    const handleConfirmDelete = async (deleteItem: any) => {
        try {
            let res: any = await lienKetSevices.deleteLienKet(deleteItem.id);
                ...
                <tbody>
                    {dataToDisplay.map((item: any) => (
                        <tr key={item.id}>
                            ...
                            <td>{formatDateTime(item.ngayLienKet)}</td>

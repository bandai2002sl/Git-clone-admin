...
export default function Page() {
    ...
    const handleAdd = async () => {
        try {
            const response = await moHinhCongNgheCaoSevices.createMoHinhCongNgheCao(newItem)
    ...
    const handleConfirmDelete = async (deleteItem: any) => {
        try {
            const response = await moHinhCongNgheCaoSevices.deleteMoHinhCongNgheCao(deleteItem.id);

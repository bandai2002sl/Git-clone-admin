...
import AddNewItemModal from "~/components/page/trong-trot/san-xuat-trong-trot/modalAddNew";
import "bootstrap/dist/css/bootstrap.min.css";
import { Modal, ModalBody, ModalFooter, ModalHeader } from "reactstrap";
import sanXuatTrongTrotSevices from "~/services/sanXuatTrongTrotSevices";
import ModalEdit from "~/components/page/trong-trot/san-xuat-trong-trot/modalEdit";
...
export default function Page() {
    ...
    const handleConfirmDelete = async (deleteItem: any) => {
        try {
            let res: any = await sanXuatTrongTrotSevices.deleteSanXuatTrongTrot(deleteItem.id);
    ...
    return (
        <Fragment>
            ...
            <div>
                <CheckPermission
                    pageKey={PageKey.San_xuat_trong_trot}
                ...
                <tbody>
                    {dataToDisplay.map((item: any) => (
                        <tr key={item.id}>
                            ...
                            <td>{item.nangSuat}</td>
                            <td>{item.sanLuong}</td>
                            <td>{formatDateTime(item.thoiDiemBaoCao)}</td>
                            <td>{item.diaChi}</td>
